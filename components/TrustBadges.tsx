        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5 lg:gap-4">
          {badges.map((badge, index) => (
            ...
            >
              ...
              <p className="mt-2 text-xl font-extrabold text-primary sm:text-2xl">
                {"animated" in badge && badge.animated ? (
                  <AnimatedCounter
                    end={badge.animated.end}
                    suffix={badge.animated.suffix}
                  />
                ) : (
                  badge.title
                )}
